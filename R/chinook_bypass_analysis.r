...
modfits.cov.lgr.w <- fitModels(covsets, respsets[idam], cdat, subsets[[1]] & cdat$clipped=="b. no")
...
modfit.len.lgr.w <- fitModels(tmpset, respsets[idam], cdat, subsets[[1]] & cdat$clipped=="b. no")
...
# -------   Fit covariate-only models -------------------------------------
modfits.cov.lgs.w <- fitModels(covsets, respsets[idam], cdat, cdat$clipped=="b. no")
...
modfit.len.lgs.w <- fitModels(tmpset, respsets[idam], cdat, cdat$clipped=="b. no")
...
# -------   Fit covariate-only models -------------------------------------
modfits.cov.lmn.w <- fitModels(covsets, respsets[idam], cdat, cdat$clipped=="b. no")
...
modfit.len.lmn.w <- fitModels(tmpset, respsets[idam], cdat, cdat$clipped=="b. no")
...
# -------   Fit covariate-only models -------------------------------------
modfits.cov.ihr.w <- fitModels(covsets, respsets[idam], cdat, cdat$clipped=="b. no" & cdat$fyear %in% as.character(2005:2014))

# check if any models did not converge (any non-zero)
modfits.cov.ihr.w$converge 

# Calculate AIC
aicsum.cov.ihr.w <- getAICsummary(modfits.cov.ihr.w, covsets, cov.modnums)
aicsum.cov.ihr.w
...
modfit.len.ihr.w <- fitModels(tmpset, respsets[idam], cdat, cdat$clipped=="b. no"  & cdat$fyear %in% as.character(2005:2014))
...
# -------   Fit covariate-only models -------------------------------------
modfits.cov.mcn.w <- fitModels(covsets, respsets[idam], cdat, cdat$clipped=="b. no")
...
modfit.len.mcn.w <- fitModels(tmpset, respsets[idam], cdat, cdat$clipped=="b. no")
...
# -------   Fit covariate-only models -------------------------------------
modfits.cov.jda.w <- fitModels(covsets, respsets[idam], cdat, cdat$clipped=="b. no")
...
modfit.len.jda.w <- fitModels(tmpset, respsets[idam], cdat, cdat$clipped=="b. no")
...
# -------   Fit covariate-only models -------------------------------------
modfits.cov.bon.w <- fitModels(covsets, respsets[idam], cdat, subsets[[2]] & cdat$clipped=="b. no")

# check if any models did not converge (any non-zero)
modfits.cov.bon.w$converge 
# note: models 25 and 26 fail to converge

# Calculate AIC
aicsum.cov.bon.w <- getAICsummary(modfits.cov.bon.w[-c(25,26)], covsets[-c(25,26)], cov.modnums[-c(25,26)])
aicsum.cov.bon.w
...
modfit.len.bon.w <- fitModels(tmpset, respsets[idam], cdat, subsets[[2]] & cdat$clipped=="b. no")
...
# -------   Fit covariate-only models -------------------------------------
modfits.cov.bcc.w <- fitModels(covsets, respsets[idam], cdat, subsets[[3]] & cdat$clipped=="b. no")
...
# Calculate AIC
aicsum.cov.bcc.w <- getAICsummary(modfits.cov.bcc.w, covsets)
aicsum.cov.bcc.w
...
modfit.len.bcc.w <- fitModels(tmpset, respsets[idam], cdat, subsets[[3]] & cdat$clipped=="b. no")
...
tab1.w <- data.frame(Species=rep("Chinook",8), Type=rep("W", 8), Dam=dnames, 
...
tabA3.w <- data.frame(Species=rep("Chinook",8), Type=rep("W", 8), Dam=dnames, 
...
idam <- which(damsets=="LGR")
# -------   Fit covariate-only models -------------------------------------
modfits.cov.lgr.h <- fitModels(covsets, respsets[idam], cdat, subsets[[1]] & cdat$clipped=="a. yes")
...
modfit.len.lgr.h <- fitModels(tmpset, respsets[idam], cdat, subsets[[1]] & cdat$clipped=="a. yes")
...
idam <- which(damsets=="LGS")
# -------   Fit covariate-only models -------------------------------------
modfits.cov.lgs.h <- fitModels(covsets, respsets[idam], cdat, cdat$clipped=="a. yes")
...
modfit.len.lgs.h <- fitModels(tmpset, respsets[idam], cdat, cdat$clipped=="a. yes")
...
idam <- which(damsets=="LMN")
# -------   Fit covariate-only models -------------------------------------
modfits.cov.lmn.h <- fitModels(covsets, respsets[idam], cdat, cdat$clipped=="a. yes")
...
modfit.len.lmn.h <- fitModels(tmpset, respsets[idam], cdat, cdat$clipped=="a. yes")
...
idam <- which(damsets=="IHR")
# -------   Fit covariate-only models -------------------------------------
modfits.cov.ihr.h <- fitModels(covsets, respsets[idam], cdat, cdat$clipped=="a. yes" & cdat$fyear %in% as.character(2005:2014))
...
modfit.len.ihr.h <- fitModels(tmpset, respsets[idam], cdat, cdat$clipped=="a. yes"  & cdat$fyear %in% as.character(2005:2014))
...
idam <- which(damsets=="MCN")
# -------   Fit covariate-only models -------------------------------------
modfits.cov.mcn.h <- fitModels(covsets, respsets[idam], cdat, cdat$clipped=="a. yes")
...
modfit.len.mcn.h <- fitModels(tmpset, respsets[idam], cdat, cdat$clipped=="a. yes")
...
idam <- which(damsets=="JDA")
# -------   Fit covariate-only models -------------------------------------
modfits.cov.jda.h <- fitModels(covsets, respsets[idam], cdat, cdat$clipped=="a. yes")
...
modfit.len.jda.h <- fitModels(tmpset, respsets[idam], cdat, cdat$clipped=="a. yes")
...
idam <- which(damsets=="BON")
# -------   Fit covariate-only models -------------------------------------
modfits.cov.bon.h <- fitModels(covsets, respsets[idam], cdat, subsets[[2]] & cdat$clipped=="a. yes")
...
modfit.len.bon.h <- fitModels(tmpset, respsets[idam], cdat, subsets[[2]] & cdat$clipped=="a. yes")
...
idam <- which(damsets=="BCC")
# -------   Fit covariate-only models -------------------------------------
modfits.cov.bcc.h <- fitModels(covsets, respsets[idam], cdat, subsets[[3]] & cdat$clipped=="a. yes")

# check if any models did not converge (any non-zero)
modfits.cov.bcc.h$converge 
# note: model 26 fails to converge

# Calculate AIC
aicsum.cov.bcc.h <- getAICsummary(modfits.cov.bcc.h[-26], covsets[-26], cov.modnums[-26])
aicsum.cov.bcc.h
...
modfit.len.bcc.h <- fitModels(tmpset, respsets[idam], cdat, subsets[[3]] & cdat$clipped=="a. yes")
...
tab1.h <- data.frame(Species=rep("Chinook",8), Type=rep("H", 8), Dam=dnames, 
...
tabA3.h <- data.frame(Species=rep("Chinook",8), Type=rep("H", 8), Dam=dnames, 
